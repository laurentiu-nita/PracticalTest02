...
//    private final HashMap<String, OperationInformation> data;
...
//        this.data = new HashMap<String, OperationInformation>();
    }
...
//    public synchronized void setData(String operation, OperationInformation operationInformation) {
//        this.data.put(operation, operationInformation);
//    }
//
//    public synchronized HashMap<String, OperationInformation> getData() {
//        return data;
//    }
